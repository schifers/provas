...
import br.com.schifers.concursos.builder.MenuBuilder;
import br.com.schifers.concursos.builder.MenuItemBuilder;
import br.com.schifers.concursos.builder.MenuMenuItemBuilder;
import br.com.schifers.concursos.builder.MenuTypeBuilder;
...
public class MenuServiceTest {
    ...
    public void testBuildMenu() {
        ...
        MenuItem root2child1 = new MenuItemBuilder().id(4L).name("root2child1").menuType(itemType).parent(root2).build();
        MenuItem root2child2 = new MenuItemBuilder().id(5L).name("root2child2").menuType(listType).parent(root2).build();
        MenuItem root2child3 = new MenuItemBuilder().id(6L).name("root2child3").menuType(listType).parent(root2).build();

        MenuItem root2child2child1 = new MenuItemBuilder().id(7L).name("root2child2child1").menuType(itemType).parent(root2child2).build();
        MenuItem root2child3child1 = new MenuItemBuilder().id(8L).name("root2child3child1").menuType(itemType).parent(root2child3).build();

        MenuItem root3child1 = new MenuItemBuilder().id(9L).name("root3child1").menuType(listType).parent(root3).build();
        MenuItem root3child2 = new MenuItemBuilder().id(10L).name("root3child2").menuType(itemType).parent(root3).build();

        MenuItem root3child1child1 = new MenuItemBuilder().id(11L).name("root3child1child1").menuType(itemType).parent(root3child1).build();
        ...
        MenuMenuItem link01 = new MenuMenuItemBuilder().id(1L).menu(menu).menuItem(root1).order(0).build();
        MenuMenuItem link02 = new MenuMenuItemBuilder().id(2L).menu(menu).menuItem(root2).order(1).build();
        MenuMenuItem link03 = new MenuMenuItemBuilder().id(3L).menu(menu).menuItem(root3).order(2).build();
        MenuMenuItem link04 = new MenuMenuItemBuilder().id(4L).menu(menu).menuItem(root2child1).order(2).build();
        MenuMenuItem link05 = new MenuMenuItemBuilder().id(5L).menu(menu).menuItem(root2child2).order(1).build();
        MenuMenuItem link06 = new MenuMenuItemBuilder().id(6L).menu(menu).menuItem(root2child3).order(0).build();
        MenuMenuItem link07 = new MenuMenuItemBuilder().id(7L).menu(menu).menuItem(root2child2child1).order(0).build();
        MenuMenuItem link08 = new MenuMenuItemBuilder().id(8L).menu(menu).menuItem(root2child3child1).order(0).build();
        MenuMenuItem link09 = new MenuMenuItemBuilder().id(9L).menu(menu).menuItem(root3child1).order(1).build();
        MenuMenuItem link10 = new MenuMenuItemBuilder().id(10L).menu(menu).menuItem(root3child2).order(0).build();
        MenuMenuItem link11 = new MenuMenuItemBuilder().id(11L).menu(menu).menuItem(root3child1child1).order(0).build();
